...
import ActionBtnsForTimeline from '@/components/ui/ActionBtnsForTimeline';
...
const FriendsDetailsPage = async ({params}) => {
   ...
   console.log(params);
    ...
    console.log(friends, friendId ,"details page");
    ...
    return (
        <div className="p-6  bg-gray-100 min-h-screen container mx-auto">
            <div className=" grid grid-cols-1 md:grid-cols-6 gap-4">
                ...
                {
                  actions.map((item, i) => (
                    <ActionBtnsForTimeline key={i}  label={item.label} type={item.type} specificFriend={specificFriend}  />
                  ))
                    }
                   </div>
                 </div>
